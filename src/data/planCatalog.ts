...
export const ENTITY_IMAGES: Record<string, string> = {
  'ticket-ga': `${BASE}ticket-ga-chateau.jpg`,
  'ticket-vip': `${BASE}ticket-vip-booth.jpg`,
...
export const ENTITY_GALLERIES: Record<string, string[]> = {
  'ticket-ga': [`${BASE}ticket-ga-chateau.jpg`, `${BASE}ticket-ga-grounds.jpg`],
  'ticket-vip': [`${BASE}ticket-vip-booth.jpg`, `${BASE}ticket-vip-decks.jpg`],
